                        ...
                        <div class="Form-Box-Right">
                            ...
                            <div class="Form-Split">
                                <div>
                                    ...
                                    <input type="number" min="0" max="1" value={this.state.flashlights} onChange={e => this.setState({ flashlights: +e.target.value })} />
                                </div>
                                <div>
                                    <h3>Yellow FlashLights ($30)</h3>
                                    <input type="number" min="0" max="1" value={this.state.flashlight_yellow} onChange={e => this.setState({ flashlight_yellow: +e.target.value })} />
                                </div>
                                <div>
                                    <h3>Lanterns ($35)</h3>
                                    <input type="number" min="0" max="1"  value={this.state.pucs} onChange={e => this.setState({ pucs: +e.target.value })} />
                                </div>
                            </div>
                            <div class="Form-Split">
                                {/* <div>
