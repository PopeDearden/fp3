          ...
          <div className="General-Page" >
            <div class="General-Content">
              ...
              <div className={`Form-Box-${this.state.toggle}`}>
                ...
                <h2 id="bad">***THIS FEATURE IS CURRENTLY NOT FUNCTIONAL- IN DEVELOPMENT***</h2>
                  <h2>Sample History</h2>
                  <br></br>
                  <table class="Finalize">
                    <tr>
                      <th>Date</th>
                      <th>Black Flashlights</th>
                      <th>Yellow Flashlights</th>
                      <th>Yellow Lanterns</th>
                      <th>Comment</th>
                    </tr>
