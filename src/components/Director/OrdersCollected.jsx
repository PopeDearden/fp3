...
class OrdersCollected extends Component{
  constructor(s) {
    super()
    this.state = {
      totalFlash: 0,
      ...
      <div className="App" >
       <h2 class="Title-Bar-Collected"><i class="fas fa-money-check-alt"></i>   Orders w/ money collected for your school : </h2>
        <div class="TopCards">
          ...
          <div class="TopCard1">
            <div class="TopCard1Bar">
              <h2>Total Potential<br></br>Earnings </h2>
            </div>
            <h3>
              ${this.state.possible}
            </h3>
          ...
          {student.map(student => (
            <table class="InProgressTable">
              ...
              <tr id="DataRowTotal">
                ...
                <td id="TotalCollected">${this.calculate(orders, student).totalPrice.toFixed(2)}</td>
              </tr>
            </table>
          ))}
...
export default OrdersCollected;
