select userinfo.first_name, userinfo.last_name, userinfo.user_id, ordertable.confirmed,
...
from ordertable
right join userinfo ON userinfo.user_id = ordertable.user_id
where userinfo.director_tag = $1
group by userinfo.first_name,
ordertable.confirmed,
userinfo.user_id,
userinfo.last_name,
ordertable.user_id, 
userinfo.sample_light_black,
userinfo.sample_light_yellow,
userinfo.sample_puc_yellow
order by confirmed, userinfo.last_name;
